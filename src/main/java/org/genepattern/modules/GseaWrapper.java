...
public class GseaWrapper extends AbstractModule {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        try {
            ...
            String geneSetsSelector = determineSelectorFromParams(geneSetDBParam, geneSetDBListParam, selectedGeneSetsParam, altDelim, gpMode, tmp_working, klog, hasParamFile);
            ...
            tool = new Gsea(paramProps, paramFileOption);
            try {
