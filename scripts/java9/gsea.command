...
exec java --module-path="$prefix"/modules -Xmx4g \
    ...
    --add-exports=jide.common/com.jidesoft.grid=org.broad.gsea --add-exports=jide.common/com.jidesoft.docking=org.broad.gsea --add-exports=jide.common/com.jidesoft.status=org.broad.gsea \
