...
exec java --module-path="$prefix"/modules -Xmx4g \
    ...
    --add-exports=jide.common/com.jidesoft.grid=org.gsea_msigdb.gsea --add-exports=jide.common/com.jidesoft.docking=org.gsea_msigdb.gsea --add-exports=jide.common/com.jidesoft.status=org.gsea_msigdb.gsea \
